...
exports.Environment = Environment = function(options) {
   ...
   this.resourcesDir = this.loader && typeof(this.loader.findResourcesDir) === "function" ? this.loader.findResourcesDir() : "./resources";
...
Environment.prototype.renderResponse = function(templateName, context) {
   ...
   if (context && context.locale && this.i18n && this.i18n.resBundleFactory) {
	   context.rb = this.i18n.resBundleFactory(context.locale);
   }
   return {
      status: 200,
