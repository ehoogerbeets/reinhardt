...
// find the directory that contains the translations for the trans tags
Loader.prototype.findResourcesDir = function() {
   var resDir = null;
   this.getTemplateSources("resources").some(function(templatePath) {
	  if (fs.exists(templatePath) && fs.isDirectory(templatePath)) {
         resDir = templatePath;
         return true;
      }
   });
